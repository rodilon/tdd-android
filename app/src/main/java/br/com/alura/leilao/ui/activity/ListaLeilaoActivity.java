...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Betina"), 300.0));
        Leilao home = new Leilao("Casa");
        home.propoe(new Lance(new Usuario("Pati"), 11000.0));
        home.propoe(new Lance(new Usuario("Banana"), 10500.0));
